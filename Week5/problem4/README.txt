...
PlaintextMessage, and CiphertextMessage classes, so don't worry if you did
...
CiphertextMessage object using the story string and use decrypt_message
to return the appropriate shift value and unencrypted story string.
